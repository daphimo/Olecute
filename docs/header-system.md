...
- Mobile uses an independent centered composition, with a dedicated menu control alongside search. Its quote fades and logo compacts over 120px while a stable 64px layout slot prevents content jumps.
